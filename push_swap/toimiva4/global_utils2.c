...
/*   Updated: 2025/01/17 11:44:40 by vlopatin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static int	find_gap_for_extremes(int *stack, t_dir dir, int min, int max)
{
	int	i;
...
static int	find_gap_within_range(int *stack, t_dir dir, int nb)
{
	int	i;
